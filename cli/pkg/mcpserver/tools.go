...
func (s *server) addTools(srv *mcp.Server) {
	mcp.AddTool(srv, &mcp.Tool{
		Name:         "list_projects",
		OutputSchema: outSchema[listProjectsResult](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		OutputSchema: outSchema[client.ListExceptionsResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		OutputSchema: outSchema[client.ExceptionByIdResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		Name:         "query_logs",
		OutputSchema: outSchema[client.QueryLogsResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		Name:         "list_endpoints",
		OutputSchema: outSchema[client.ListEndpointsResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		OutputSchema: outSchema[client.EndpointDetailResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		OutputSchema: outSchema[client.EndpointChartResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		OutputSchema: outSchema[client.SlowEndpointResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		Name:         "get_task",
		OutputSchema: outSchema[client.TaskDetailResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		Name:         "get_ai_trace",
		OutputSchema: outSchema[client.AiTraceDetailResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		Name:         "get_session",
		OutputSchema: outSchema[client.SessionDetailResponse](),
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		OutputSchema: outSchema[archiveResult](),
