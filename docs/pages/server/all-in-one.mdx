...
<Callout type="info">
  Because both databases live inside the container, this image runs as a single instance. To run several backend instances, point the [minimal image](/server/minimal#running-more-than-one-instance) at shared databases.
</Callout>
